...
-->
    ...
    <?php echo heading('Tesis Disponibles para Descargar:', 3);?>
        ...
        <?php if($files){ ?>        
        <?php if(is_array($resultados) && !is_null($resultados)){?>
            ...
            <?php foreach($resultados as $fila){ ?>
                ...
                <?php if ($fila->ruta==$file) { ?> 
                    <?php foreach ($titulos as $titulo){ ?>      
                    <?php if ($fila->titulo==$titulo->titulo) { ?> 
        ...
        else{?><?php echo heading('No hay archivos para descargar ', 3).anchor('admin', 'Subir un Archivo');?><?php } ?>
        <?php 
        } //if($files)
        else{?><?php echo heading('No hay archivos para descargar ', 3).anchor('admin', 'Subir un Archivo');?><?php } ?>
        </table>
